...
#SBATCH --mail-user=maeva.leitwein.l@ulaval.ca
...
#variables
GENOME="04_reference/genome_filtered.fna"           #use genome_filtered.fa if removing C-T SNPs from the reference genome 
